...
class ErrorAbstract extends Error implements ArrayAccess
{
    ...
    public function error101(){
        ...
        return trans('joymap::errors.validate_error');
    }
    ...
    public function error500(){
        ...
        return trans('joymap::errors.operation_error');
    }
    ...
    public function error400(){
        ...
        return trans('joymap::errors.not_allow_request', $replaces['400']);
    }
